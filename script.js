    ...
    tracks: [
        {
            ...
            duration: "2:02",
            audio: "Дрифтуй!.mp3",
            lyrics: "я-а-а-а-а\nя-а-а-а-а\nя. эй\n\n[Verse]\nя дрифчу и езжу как пидор те по губа-\nсука знаю хашираму тебе сука минима-\nнига я насрал на волка дайте ему в ебло (спиздил диби девять, ебать)\nя. (сука)\nблок. на меня напала нежить, дайте мне пожить ещё\nмама тебя вставила в 6 утра дайте ей пожить ещё\nя не могу снимать порнуху ведь уже булкин ебёт подругу правого рУля - ушёл.\n\n[Break]\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй.)\n\n[Verse]\nя дрифчу и езжу как пидор те по губа-\nсука знаю хашираму тебе сука минима-\nнига я насрал на волка дайте ему в ебло (спиздил диби девять, ебать)\nя. (сука)\nблок. на меня напала нежить, дайте мне пожить ещё\nмама тебя вставила в 6 утра дайте ей пожить ещё\nя не могу снимать порнуху ведь уже булкин ебёт подругу правого рУля - ушёл.\n\n[Verse 2]\nНа меня напала тёлка - спиздил у неё жилет и кучу бабок да ненадо мне прямо сейчас давать в еблет-\nмне красный чухан ёбаный заплатит\nпока я буду трахать и ебать. твою матерь-\nсука знает меня с какой стати я начал захватывать район\n(ебаный ты уё-)\nда-да-да-да-да-да-да (Оу, СУКА!)\n\n[Autro]\nNeed for Speed - Carbon"
        },
        {
            id: 2,
            title: "Дрифтуй! (Part 2)",
            artist: "Wuro, эмси чума",
            duration: "2:03",
            audio: "Дрифтуй! (Part 2).mp3",
            lyrics: "я-а-а-а-а (копы сзади, сука!)\nя-а-а-а-а (тачку конфисковали, бля!)\nя. эй\n\n[Verse]\nя дрифчу по трассе как будто я ебу асфаль-\nсука видел этого мента он хотел мне дать медаль (в жопу!)\nнига я залил полный бак дайте мне нитро в рот (ву-ву, ебать!)\nя. (газу)\nблок. на меня напал этот Энгл, дайте мне уйти в отрыв\nмаму твою вставило в кювет, дайте ей ещё бусты\nя не могу тачку тюнинговать ведь уже Вольф снял подвеску с моего Мустанга - ушёл.\n\n[Break]\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nВ жопу ментов! (Дрифтуй!)\nЗахватывай район! (Дрифтуй!)\nДави тапку в пол! (Дрифтуй!)\nДарт Вейдер звонит! (Дрифтуй!)\nДрифтуй! (Дрифтуй!)\nДрифтуй! (Дрифтуй.)\n\n[Verse]\nя дрифчу по трассе как будто я ебу асфаль-\nсука видел этого мента он хотел мне дать медаль (в жопу!)\nнига я залил полный бак дайте мне нитро в рот (ву-ву, ебать!)\nя. (газу)\nблок. на меня напал этот Энгл, дайте мне уйти в отрыв\nмаму твою вставило в кювет, дайте ей ещё бусты\nя не могу тачку тюнинговать ведь уже Вольф снял подвеску с моего Мустанга - ушёл.\n\n[Verse 2]\nНа меня напали копы - спиздил у них винтовку и кучу улик да ненадо мне прямо сейчас给你们 в рот этот радар-\nмне Никиту из Токио Дрифт заплатит\nпока я буду газовать и дрифтовать. на тачке твоего брата-\nсука знает меня с какой стати я начал захватывать Палмонт-Сити\n(ебаный ты уё-)\nжми-жми-жми-жми-жми (Оу, КАРБОН!)\n\n[Autro]\nNeed for Speed - Carbon"
        },
        {
            id: 3,
            title: "Дрифтуй! (Part 3)",
            artist: "Wuro, эмси б4мжиха",
            duration: "3:01",
            audio: "Дрифтуй! (Part 3).mp3",
            lyrics: "я-а-а-а-а (Вольф на хвосте, сука!)\nя-а-а-а-а (шестерёнки выли, бля!)\nя. эй\n\n[Verse]\nя дрифчу в Палмонте как будто я ебу этот асфальт зуба-\nсука Кеничи знает меня он хотел мне дать по газам (но я дал ему по рогам!)\nнига я завалил Энгла дайте мне его тачку в рот (вэй, вэй, ебать!)\nя. (дави!)\nблок. на меня напали эти уличные пидоры, дайте мне выиграть заезд\nмаму твою вставило в стекло, дайте ей проехать ещё\nя не могу найти запчасти ведь уже Дариус спиздил все деньги с моего счёта - ушёл.\n\n[Break]\nЗахватывай! (Захватывай!)\nЗахватывай! (Захватывай!)\nТерриторию! (Захватывай!)\nЭнгла в жопу! (Захватывай!)\nДариус пидор! (Захватывай!)\nНикки предала! (Захватывай!)\nЗахватывай! (Захватывай!)\nЗахватывай! (Захватывай!)\n\n[Verse]\nя дрифчу в Палмонте как будто я ебу этот асфальт зуба-\nсука Кеничи знает меня он хотел мне дать по газам (но я дал ему по рогам!)\nнига я завалил Энгла дайте мне его тачку в рот (вэй, вэй, ебать!)\nя. (дави!)\nблок. на меня напали эти уличные пидоры, дайте мне выиграть заезд\nмаму твою вставило в стекло, дайте ей проехать ещё\nя не могу найти запчасти ведь уже Дариус спиздил все деньги с моего счёта - ушёл.\n\n[Verse 2]\nНа меня напали тачки из Stack Deck - спиздил у них нитро и кучу спойлеров да ненадо мне прямо сейчас ебать их в этом дрифте-\nмне сам Кеничи заплатит за то что я выебу его дочку Саманту\nпока я буду газовать и трахать этот асфальт. на тачке из Bushido\nсука знает меня с какой стати я начал захватывать все районы Палмонта\n(ебаный ты уё-)\nжми-жми-жми-жми-жми (Оу, ЭТО КАРБОН!)\n\n[Bridge]\nя перешёл дорогу Дариусу, сука, он забрал мои районы\nНикки сказала что любит но сама лизала ему бубоны\nтеперь я езжу на Мустанге, обоссаном и старом\nно я вернусь и выебу всех, как ебут под шум самовара\nя соберу команду из гонщиков, наркоманов и воров\nКеничи, Кольт, Вольф — мы выебем этих пидоров\nИмбрика мне даст движок, Англи даст подвеску\nа я им дам по жопе и наклею на тачку ихнюю блядскую пиэску\n\n[Verse 3]\nя ебу этот Каньон своими колёсами, сука, смотри как я визжу\nу Энгла глаз на лоб полез когда я ему в рот положил свою трассу\nменя хочет остановить все копы Палмонта, сука, но мне похуй\nя быстрее чем их радары, быстрее чем их моторы, быстрее чем их еб...\nя дрифтую так, что асфальт плавится и течёт в рот мусорам\nменя боятся все тачки, все кланы, все районы, сука, я тут самый злой таран\nДариус прячется в Silverton, ссыт в штаны, закрылся в особняке\nно я приду к нему ночью и нарисую на его лбу свой автограф на пике\nя заберу все районы обратно, я выебу эту игру\nNeed for Speed Carbon — я тут всех имею, сука, я тут всех порву!\n\n[Autro]\nя-а-а-а-а (Чемпион района!)\nя-а-а-а-а (Дариус — пидор!)\nя. эй\n(Звук затухающего мотора и дрифта)"
        }
    ]
};

// Общий массив альбомов
const albumsData = [
    { album: config1.album, tracks: config1.tracks },
    { album: config2.album, tracks: config2.tracks },
    { album: config3.album, tracks: config3.tracks }
];
...
function init() {
    ...
    setupVisualizer();
    createParticles();
    initMobilePlayer(); // добавляем логику сворачивания плеера
}
...
// ============================================
// ПОДСЧЁТ ОБЩЕЙ ДЛИТЕЛЬНОСТИ АЛЬБОМА
// ============================================
...
function togglePlay() {
    if (!audio.src || !currentAlbumData) {
        if (currentAlbumData) playTrack(0);
        return;
    }
...
function prevTrack() {
    ...
    if (shuffleMode) {
        ...
        if (prevIndex < 0) prevIndex = currentAlbumData.tracks.length - 1;
    }
    playTrack(prevIndex);
}
...
function updateVolumeIcon(volume) {
    const btn = document.getElementById('volume-btn');
    if (volume === 0) btn.innerHTML = '<i class="fas fa-volume-mute"></i>';
    else if (volume < 0.5) btn.innerHTML = '<i class="fas fa-volume-down"></i>';
...
// ============================================
// МОБИЛЬНЫЙ ПЛЕЕР (СВОРАЧИВАНИЕ / РАЗВОРАЧИВАНИЕ)
// ============================================
function initMobilePlayer() {
    const player = document.getElementById('player');
    const dragHandle = document.querySelector('.player-drag-handle');

    // Начальное состояние в зависимости от ширины
    function updatePlayerState() {
        if (window.innerWidth <= 768) {
            player.classList.remove('expanded'); // по умолчанию свёрнут
        } else {
